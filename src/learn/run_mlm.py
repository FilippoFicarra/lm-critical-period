...
class DataTrainingArguments:
    ...
    validation_file: Optional[str] = field(
        default=None,
        metadata={"help": "An optional input evaluation data file to evaluations the perplexity on (a text file)."},
    )
...
class RobertaWithEWCLoss(RobertaForMaskedLM):
    def __init__(self, *args, ewc_strength=150, **kwargs):
...
def main():
    ...
    if model_args.model_name_or_path:
        model_class = RobertaWithEWCLoss if model_args.use_ewc else AutoModelForMaskedLM
